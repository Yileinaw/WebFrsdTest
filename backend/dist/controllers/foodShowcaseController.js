...
const getAllFoodShowcases = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        const tags = req.query.tags; // Get tags directly as string
        const page = parseInt(req.query.page, 10) || 1;
        const limit = parseInt(req.query.limit, 10) || 10;
        // Default includeTags to true if not specified or invalid
        const includeTagsParam = req.query.includeTags;
        ...
        const result = yield FoodShowcaseService_1.FoodShowcaseService.getAllShowcases(options);
...
const updateShowcaseById = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        if (imageUrl !== undefined)
            dataToUpdate.imageUrl = imageUrl; // Only add if new image was uploaded
        ...
        const updatedShowcase = yield FoodShowcaseService_1.FoodShowcaseService.updateShowcase(showcaseId, dataToUpdate);
        if (!updatedShowcase) {
