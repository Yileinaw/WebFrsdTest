...
const AdminPostController_1 = require("../controllers/AdminPostController"); // 将在后续步骤创建
const AuthMiddleware_1 = require("../middleware/AuthMiddleware");
const AdminMiddleware_1 = require("../middleware/AdminMiddleware"); // 确认此中间件已存在且功能正确
 ...
 */
router.get('/', AdminPostController_1.AdminPostController.getPosts); // 控制器方法将在后续步骤创建
/**
 * @swagger
 * /api/admin/posts/{id}:
 *   delete:
 ...
 *         description: 帖子未找到
 */
router.delete('/:id', AdminPostController_1.AdminPostController.deletePost); // 控制器方法将在后续步骤创建
...
//# sourceMappingURL=AdminPostRoutes.js.map