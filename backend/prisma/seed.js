...
function main() {
  return __awaiter(this, void 0, void 0, function* () {
    ...
    const passwordAlice = yield bcrypt_1.default.hash(
      "password123",
      saltRounds
    );
    ...
    try {
      ...
      console.log(
        `Successfully created/updated admin user: ${adminUser.email} (ID: ${adminUser.id}, Role: ${adminUser.role})`
      );
    } catch (error) {
      console.error(
        `Error creating/updating admin user (${adminEmail}):`,
        error
      );
    ...
    console.log(
      "Creating FoodShowcase entries for all images in public/images/food (prefixed with /static)..."
    );
    const foodImages = [
      ...
      {
        imageUrl:
          "/static/images/food/tempting_dessert_display_oLHk_WLupSc.jpg",
      },
      {
        imageUrl:
          "/static/images/food/tempting_dessert_display_pGM4sjt_BdQ.jpg",
      },
      {
        imageUrl:
          "/static/images/food/tempting_dessert_display_U_zIfKfEoRM.jpg",
      },
      {
        imageUrl:
          "/static/images/food/tempting_dessert_display_ZkgWJ4BfgsE.jpg",
      },
      {
        imageUrl:
          "/static/images/food/tempting_dessert_display_JVK7ssGd1qc.jpg",
      },
      ...
      {
        imageUrl:
          "/static/images/food/gourmet_food_photography_sil2Hx4iupI.jpg",
      },
      {
      ...
      {
        imageUrl:
          "/static/images/food/gourmet_food_photography_9aaKx1NZPQw.jpg",
      },
      {
        imageUrl:
          "/static/images/food/gourmet_food_photography_eNfR6MUyjBI.jpg",
      },
      {
        imageUrl:
          "/static/images/food/gourmet_food_photography_12eHC6FxPyg.jpg",
      },
      {
      ...
      {
        imageUrl:
          "/static/images/food/chocolate_cake_slice_closeup_pGM4sjt_BdQ.jpg",
      },
      {
        imageUrl:
          "/static/images/food/cozy_restaurant_interior_uKdzZgTP398.jpg",
      },
      {
        imageUrl:
          "/static/images/food/chocolate_cake_slice_closeup_Uq6gVE6OsIc.jpg",
      },
      {
        imageUrl:
          "/static/images/food/chocolate_cake_slice_closeup_ZkgWJ4BfgsE.jpg",
      },
      {
        imageUrl:
          "/static/images/food/chocolate_cake_slice_closeup_LGNxQzYmeUk.jpg",
      },
      { imageUrl: "/static/images/food/chef_cooking_action_08bOYnH_r_E.jpg" },
      {
        imageUrl:
          "/static/images/food/chocolate_cake_slice_closeup_6dzARthU17g.jpg",
      },
    ...
    console.log(
      `Created ${foodImages.length} FoodShowcase entries with actual image paths (prefixed with /static).`
    );
